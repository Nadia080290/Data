...
import ModalInfoGeo from './ModalInfoGeo';
...
export default function TableGEo() {
  ...
  return (
    <Box sx={{ width: '95%', ml:2, mt: 4}}>
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                 ...
                 {/*      <Checkbox
                    ...
                    <TableCell align="right">{row.carbs}</TableCell>
                    <TableCell align="right"><VisibilityIcon sx={{color: "#FA7900"}} onClick={handleClickOpen}/></TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
      ...
      <ModalInfoGeo open={openModal} close={handleClose}/>
    </Box>
  );
}